      ...
      <div className="w-full max-w-md glass-card rounded-2xl p-8 border border-slate-200/80 relative z-10 bg-white/95">
        ...
        <div className="mt-8 pt-6 border-t border-slate-200/60">
          ...
          <div className="space-y-2">
            ...
            >
              <div>
                <span className="font-semibold text-slate-700">Sinh viên (Student)</span>
                <p className="text-[10px] text-slate-400">student@sis.hust.edu.vn</p>
              </div>
              <span className="text-[10px] px-2 py-0.5 bg-primary-50 text-primary-600 border border-primary-200 rounded-md group-hover:bg-primary-500 group-hover:text-white transition-all font-semibold">
                Chọn
              </span>
            </button>
